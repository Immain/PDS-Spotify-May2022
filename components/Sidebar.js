...
import { playistIdState, playlistIdState } from '../atoms/playlistAtom';
...
function Sidebar() {
    ...
    const [playlistId, setPlaylistId] = useRecoilState(playistIdState);
    ...
    console.log(session, spotifyApi);
